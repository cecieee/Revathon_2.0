    ...
    <section id="about" className="w-full py-16 px-4 md:px-8 text-white">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-8 md:gap-12">
        ...
        <div className="w-[80vw] md:w-1/2 text-center md:text-left">
          <h2 className="text-2xl md:text-4xl font-bold mb-6 uppercase tracking-wider"><span className='text-xl'>About</span><br></br><span className='text-primary'>Rev</span>-<span>A</span>-<span className='text-secondary'>Thon</span>1.0</h2>
