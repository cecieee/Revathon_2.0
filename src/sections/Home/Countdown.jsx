...
export default function Countdown() {
  ...
  return (
    <section
      id="countdown"
      className="relative py-12 md:py-24 min-h-[60vh] flex items-center justify-center overflow-hidden"
    >
          ...
          {timeUnits.map((unit, index) => (
            <div key={index} className="relative group">
              ...
              <div className="relative bg-black/40 backdrop-blur-sm border border-white/10 rounded-xl p-4 md:p-8 flex flex-col items-center justify-center overflow-hidden transition-all duration-300 hover:border-secondary/50 hover:shadow-[0_0_30px_rgba(58,191,188,0.2)]">
                ...
                {/* Number */}
                <span
                  className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white font-mono tracking-tighter mb-2 group-hover:text-secondary transition-colors"
