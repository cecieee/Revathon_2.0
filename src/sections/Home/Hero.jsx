        ...
        >
            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10 flex flex-col md:flex-row items-center">
                <div ref={textRef} className="w-full md:w-1/2 text-left">
                    ...
                    >
                        REVATHON <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-white">2.0</span>
                    </h1>
                    <p className="text-lg md:text-xl text-gray-300 max-w-lg mb-8 border-l-4 border-primary pl-4">
                        ...
                        <span className="text-primary font-bold">Reverse Engineering Hackathon</span>
                    </p>

                    <button
                        onClick={() => document.getElementById("register")?.scrollIntoView({ behavior: "smooth" })}
                        className="group relative px-8 py-3 bg-transparent border border-white/20 overflow-hidden cursor-pointer"
                    >
                        <div className="absolute inset-0 w-0 bg-primary transition-all duration-[250ms] ease-out group-hover:w-full opacity-10"></div>
                        <span className="relative text-white font-mono tracking-widest uppercase group-hover:text-primary transition-colors">Register Now</span>
