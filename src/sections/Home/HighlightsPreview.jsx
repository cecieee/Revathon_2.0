...
const HighlightsPreview = () => {
  ...
  return (
    <section ref={sectionRef} className="relative h-screen w-full bg-black overflow-hidden flex flex-col items-center justify-center mb-20">
      ...
      {images.map((src, index) => {
        ...
        return (
          <div 
            key={index}
            ref={addToRefs}
            className={`absolute w-[90vw] h-48 sm:w-40 sm:h-28 md:w-52 md:h-36 lg:w-72 lg:h-48 xl:w-96 xl:h-64 rounded-lg overflow-hidden border border-primary/40 shadow-[0_0_15px_rgba(58,191,188,0.2)] opacity-0 blur-md ${initialClass}`}
